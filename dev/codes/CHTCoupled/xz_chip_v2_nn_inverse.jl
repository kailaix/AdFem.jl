...
function plot_velo_pres_temp_cond(k) 
    ...
    tight_layout()
    savefig("xzchipv2_figures1/xzchipv2_nn_velox$k.png")
    ...
    tight_layout()
    savefig("xzchipv2_figures1/xzchipv2_nn_veloy$k.png")
    ...
    tight_layout()
    savefig("xzchipv2_figures1/xzchipv2_nn_pres$k.png")
    ...
    tight_layout()
    savefig("xzchipv2_figures1/xzchipv2_nn_temp$k.png")
    ...
    tight_layout()
    savefig("xzchipv2_figures1/xzchipv2_nn_cond$k.png")
...
for k = 1:1000
    ...
    matwrite("xzchipv2_figures1/loss$k.mat", Dict("L"=>loss_))
    close("all"); semilogy(loss_); title("loss vs. iteration")
    savefig("xzchipv2_figures1/loss$k.png")
    plot_velo_pres_temp_cond(k)
    ADCME.save(sess, "xzchipv2_figures1/nn$k.mat")
end
