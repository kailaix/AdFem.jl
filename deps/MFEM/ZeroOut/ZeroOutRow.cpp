...
class ZeroOutRowOpGPU : public OpKernel {
private:
  
public:
  explicit ZeroOutRowOpGPU(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("ZeroOutRowGpu").Device(DEVICE_GPU), ZeroOutRowOpGPU);

class ZeroOutRowGradOpGPU : public OpKernel {
private:
  
public:
  explicit ZeroOutRowGradOpGPU(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("ZeroOutRowGpuGrad").Device(DEVICE_GPU), ZeroOutRowGradOpGPU);
