...
public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    MFEM::ComputePmlTermBackward(grad_c_tensor, grad_u_tensor, grad_k1_tensor, grad_k2_tensor, 
        grad_k3_tensor, grad_k4_tensor, k1_tensor, k2_tensor, k3_tensor, k4_tensor, 
        u_tensor, betap_tensor, c_tensor, nv_tensor);
