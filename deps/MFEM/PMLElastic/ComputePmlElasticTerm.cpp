...
#include "ComputePmlElasticTerm.h"


REGISTER_OP("ComputePmlElasticTerm")
.Input("u : double")
.Input("betap : double")
.Input("e : double")
.Input("nu : double")
...
REGISTER_OP("ComputePmlElasticTermGrad")
...
class ComputePmlElasticTermOp : public OpKernel {
private:
  
public:
  explicit ComputePmlElasticTermOp(OpKernelConstruction* context) : OpKernel(context) {
  ...
  void Compute(OpKernelContext* context) override {    
    ...
    TensorShape k1_shape({mmesh.ndof * 2});
    TensorShape k2_shape({mmesh.ndof * 2});
    TensorShape k3_shape({mmesh.ndof * 2});
    TensorShape k4_shape({mmesh.ndof * 2});
    ...
    MFEM::ComputePmlElasticTermForward(
      k1_tensor,
      k2_tensor,
      k3_tensor,
      k4_tensor,
...
REGISTER_KERNEL_BUILDER(Name("ComputePmlElasticTerm").Device(DEVICE_CPU), ComputePmlElasticTermOp);



class ComputePmlElasticTermGradOp : public OpKernel {
private:
  
public:
  explicit ComputePmlElasticTermGradOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("ComputePmlElasticTermGrad").Device(DEVICE_CPU), ComputePmlElasticTermGradOp);
...
REGISTER_OP("ComputePmlElasticTermGpu")
.Input("u : double")
.Input("betap : double")
.Input("e : double")
.Input("nu : double")
...
REGISTER_OP("ComputePmlElasticTermGpuGrad")
.Input("grad_k1 : double")
.Input("grad_k2 : double")
.Input("grad_k3 : double")
.Input("grad_k4 : double")
...
class ComputePmlElasticTermOpGPU : public OpKernel {
private:
  
public:
  explicit ComputePmlElasticTermOpGPU(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("ComputePmlElasticTermGpu").Device(DEVICE_GPU), ComputePmlElasticTermOpGPU);

class ComputePmlElasticTermGradOpGPU : public OpKernel {
private:
  
public:
  explicit ComputePmlElasticTermGradOpGPU(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("ComputePmlElasticTermGpuGrad").Device(DEVICE_GPU), ComputePmlElasticTermGradOpGPU);
