...
class StrainEnergyOp : public OpKernel {
private:
  
public:
  explicit StrainEnergyOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("StrainEnergy").Device(DEVICE_CPU), StrainEnergyOp);



class StrainEnergyGradOp : public OpKernel {
private:
  
public:
  explicit StrainEnergyGradOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("StrainEnergyGrad").Device(DEVICE_CPU), StrainEnergyGradOp);
...
#ifdef USE_GPU
class StrainEnergyOpGPU : public OpKernel {
private:
  
public:
  explicit StrainEnergyOpGPU(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("StrainEnergy").Device(DEVICE_GPU), StrainEnergyOpGPU);

class StrainEnergyGradOpGPU : public OpKernel {
private:
  
public:
  explicit StrainEnergyGradOpGPU(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("StrainEnergyGrad").Device(DEVICE_GPU), StrainEnergyGradOpGPU);
