...
& ks_{ij} + \eta \dot s_{ij} = k\eta\dot e_{ij} && \mbox{Maxwell}\\
& s_{ij} = ke_{ij} + \eta \dot e_{ij} && \mbox{Kevin}\\
& k_1s_{ij} + \eta\dot s_{ij} = k_1k_2e_{ij} + (k_1+k_2) \eta\dot e_{ij} && \mbox{Standard Linear}
\end{aligned}$$
