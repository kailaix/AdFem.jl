...
@doc raw"""
    neo_hookean(u::Union{Array{Float64, 1}, PyObject}, mesh::Mesh)
...
function neo_hookean(u::Array{Float64, 1}, mesh::Mesh)
    ...
    @eval ccall((:NH_forward_Julia, $LIBMFEM), Cvoid,
         (Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Clonglong}, Ptr{Cdouble}, Ptr{Clonglong}, Ptr{Cdouble}, Ptr{Cdouble}), 
            $ic, $jc, $idi, $iv, $jdi, $jv, $u)
